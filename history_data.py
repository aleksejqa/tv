...
from sqlalchemy import exc, and_, String, Column, Table, BIGINT, REAL
...
def connect_wss_trading_view():
    wss = websocket.WebSocketApp(config.get('socket', 'url'), on_message=on_message,
...
def create_price_tables():
    ...
    for name in table_names:
        ...
        Table(table_name, metadata,
              ...
              Column('time', BIGINT, primary_key=True),
